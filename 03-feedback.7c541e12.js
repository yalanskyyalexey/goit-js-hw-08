...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a=document.querySelector(".feedback-form");if(a.addEventListener("input",(0,e.default)(r,500)),a.addEventListener("submit",o),localStorage.getItem("feedback-form-state")){const e=JSON.parse(localStorage.getItem("feedback-form-state"));a.querySelector("input").value=e.email,a.querySelector("textarea").value=e.message}function r(){const{elements:{email:e,message:t}}=a,r={email:e.value,message:t.value};localStorage.setItem("feedback-form-state",JSON.stringify(r))}function o(e){e.preventDefault();const t=JSON.parse(localStorage.getItem("feedback-form-state"));console.log(t),localStorage.removeItem("feedback-form-state"),e.currentTarget.reset()}
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.7c541e12.js.map