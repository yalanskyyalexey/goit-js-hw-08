...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const r=document.querySelector("iframe"),o=new Vimeo.Player(r),l=function(e){localStorage.setItem("videoplayer-current-time",e.seconds)},u=localStorage.getItem("videoplayer-current-time");null!==u&&o.setCurrentTime(u),o.on("timeupdate",(0,e.default)(l,1e3));
},{"lodash/throttle":"Ywd4"}]},{},["iiAF"], null)
//# sourceMappingURL=/goit-js-hw-08/02-video.6b3d2ee9.js.map